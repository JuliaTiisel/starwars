...
public class Level1State implements State {
	...
	private Rectangle ball = new Rectangle(Game.WIDHT / 2 - 5, Game.HEIGHT / 2 - 5, 10, 10);
	private Rectangle p1 = new Rectangle(0, 0, 10, 50);
	private Rectangle p2 = new Rectangle(Game.WIDHT - 10, 0, 10, 50);
	...
	public void start() {
		...
		ball.x = Game.WIDHT / 2 - 5;

		ball.y = Game.WIDHT / 2 - 5;
		Random r = new Random();
	...
	public void render(Graphics g) {
		...
		g.drawString("Player 1: " + score1, Game.WIDHT * 1 / 4 - g.getFontMetrics().stringWidth("Player 1: " + score1)/ 2, g.getFontMetrics(fonte).getHeight());
		g.drawString("Player 2: " + score2, Game.WIDHT * 3 / 4 - g.getFontMetrics().stringWidth("Player 2: " + score2)/ 2, g.getFontMetrics(fonte).getHeight());

		g.fillRect(Game.WIDHT/2 - 3, 0, 6, Game.HEIGHT);
	...
	@Override
	public void KeyPressed1(int cod) {
